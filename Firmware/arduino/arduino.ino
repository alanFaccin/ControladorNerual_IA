...
void loop() {
  int LeituraSensor = analogRead(potenciometro); //Recebe o sensor do potenciômetro
  Serial.print("\n Valor lido:");
...
//  //Caixa praticamente vazia Enche rapido | duas bombas
//  if (saida_y2[0] = 1 && saida_y2[1] = 1 && saida_y2[2] == 1 && saida_y2[3] = 0 && saida_y2[4] = 0) {
//    //liga bomba 1 e desliga valvula 1
//    digitalWrite(ReleBomba, LOW);
//    digitalWrite(ReleValvula, HIGH);
//
//    //liga bomba 2 e desliga valvula 2
//
//  }
//  // caixa abaixo do nivel ideal | uma bomba
//  if (saida_y2[0] = 0 && saida_y2[1] = 1 && saida_y2[2] == 1 && saida_y2[3] = 0 && saida_y2[4] = 0) {
//    //liga bomba 1 e desliga valvula 1
//    digitalWrite(ReleBomba, LOW);
//    digitalWrite(ReleValvula, HIGH);
//
//    //desliga bomba 2 e desliga valvula 2
//
//  }
//  // nivel ideal |desliga tudo
//  if (saida_y2[0] = 0 && saida_y2[1] = 0 && saida_y2[2] == 1 && saida_y2[3] = 0 && saida_y2[4] = 0) {
//    //desliga bomba 1 e desliga valvula 1
//    digitalWrite(ReleBomba, HIGH);
//    digitalWrite(ReleValvula, HIGH);
//
//    //desliga bomba 2 e desliga valvula 2
//  }
//  // caixa um pouco acima do nivel ideal
//  if (saida_y2[0] = 0 && saida_y2[1] = 0 && saida_y2[2] == 1 && saida_y2[3] = 1 && saida_y2[4] = 0) {
//    //desliga bomba 1 e ligar valvula 1
//    digitalWrite(ReleBomba, HIGH);
//    digitalWrite(ReleValvula, LOW);
//
//    //desliga bomba 1 e desliga valvula 2
//  }
//  // caixa muito acima do nivel ideal
//  if (saida_y2[0] = 0 && saida_y2[1] = 0 && saida_y2[2] == 1 && saida_y2[3] = 1 && saida_y2[4] = 1) {
//    //desliga bomba 1 e liga valvula 1
//    digitalWrite(ReleBomba, HIGH);
//    digitalWrite(ReleValvula, LOW);
//
//    //desliga bomba 2 e liga valvula 2
//  }
